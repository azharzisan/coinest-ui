...
export const ShimmerButton = React.forwardRef((
  ...
  return (
    <button
      ...
      className={cn(
        "group relative z-30 flex cursor-pointer items-center justify-center gap-1 overflow-hidden [border-radius:var(--radius)] border border-excep-dark/30 px-3 py-1 whitespace-nowrap text-secondary [background:var(--bg)] ",
