...
const ScrollExpand = ({
  ...
  return (
    <div
      ref={rootRef}
      className={`relative w-full h-full ${useWindowScroll ? "" : "overflow-y-auto overflow-x-hidden overscroll-contain scrollbar-none [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden"} ${className}`.trim()}
      style={style}
      {...rest}
    >
